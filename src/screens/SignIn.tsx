import { Button as Btn, Center, Heading, Image, Modal, Pressable, ScrollView, StatusBar, Text, VStack, useToast } from "native-base";
                ...
                {loginWithPass && (
                    <VStack my={5}> 
                        ...
                        <Text textAlign='center' color='blueGray.500' mt={5}>Não tem senha cadastrada?
                            <Text fontFamily='heading' color='blueGray.600' onPress={() => setShowModal(true)}> Cadastre agora</Text>
                        </Text>
                    </VStack>
                )}
